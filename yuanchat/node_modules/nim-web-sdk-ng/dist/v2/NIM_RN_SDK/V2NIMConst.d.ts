...
export declare const V2NIMErrorCode: {
    ...
    V2NIM_ERRPR_CODE_ONEWAY_DELETION_NOT_ALLOW_FOR_TARGET_MESSAGES: number;
    V2NIM_ERRPR_CODE_SENDER_CANNOT_INCLUDED_IN_TARGET_LIST: number;
    V2NIM_ERROR_CODE_ROBOT_CANNOT_SEND_TARGET_MESSAGE: number;
    V2NIM_ERROR_CODE_PIN_TARGET_MESSAGE_NOT_ALLOWED: number;
    V2NIM_ERROR_CODE_TARGET_MESSAGE_NOT_ALLOWED_REPLY: number;
    V2NIM_ERROR_CODE_TARGET_MESSAGE_NOT_ALLOWED_QUICK_COMMENT: number;
    ...
    V2NIM_ERROR_CODE_TARGETING_MESSAGE_FOR_TEAM_DISABLED: number;
    V2NIM_ERROR_CODE_INCLUSIVE_AS_FALSE_NOT_ALLOWED_FOR_SUPER_TEAM: number;
    V2NIM_ERROR_CODE_CANNOT_MAKE_SUPER_TEAM_MESSAGE_VISIBLE_TO_NEW_MEMBERS: number;
    V2NIM_ERROR_CODE_CANNOT_ALLOW_TARGETED_MESSAGES_INCLUSIVE_TO_NEW_MEMBERS: number;
    ...
    V2NIM_ERROR_CODE_FORCED_PUSH_LIST_INCLUDES_NON_TARGETED_ACCOUNTS: number;
...
export { V2NIMDataSyncLevel, V2NIMDataSyncType, V2NIMDataSyncState } from './SyncServiceInterface';
export { V2NIMConversationType, V2NIMLastMessageState } from './V2NIMConversationService';
export { V2NIMFriendAddMode, V2NIMFriendAddApplicationType, V2NIMFriendAddApplicationStatus, V2NIMFriendDeletionType, V2NIMFriendVerifyType } from './V2NIMFriendService';
export { V2NIMLoginAuthType, V2NIMLoginStatus, V2NIMLoginClientType, V2NIMKickedOfflineReason, V2NIMLoginClientChange, V2NIMConnectStatus } from './V2NIMLoginService';
export { V2NIMMessageType, V2NIMMessageNotificationType, V2NIMMessageAttachmentUploadState, V2NIMMessageSendingState, V2NIMQueryDirection, V2NIMMessageRevokeType, V2NIMMessagePinState, V2NIMMessageQuickCommentType, V2NIMClientAntispamOperateType, V2NIMSortOrder, V2NIMSystemMessageType } from './V2NIMMessageService';
export { V2NIMTeamMessageMuteMode, V2NIMP2PMessageMuteMode } from './V2NIMSettingService';
export { V2NIMTeamMemberRoleQueryType, V2NIMTeamType, V2NIMTeamJoinMode, V2NIMTeamAgreeMode, V2NIMTeamInviteMode, V2NIMTeamUpdateInfoMode, V2NIMTeamChatBannedMode, V2NIMTeamUpdateExtensionMode, V2NIMTeamJoinActionType, V2NIMTeamJoinActionStatus, V2NIMTeamNotificationType, V2NIMTeamMemberRole } from './V2NIMTeamService';
export { V2NIMAIModelRoleType, V2NIMAIModelType } from './V2NIMAIService';
export { V2NIMSignallingChannelType, V2NIMSignallingEventType } from './V2NIMSignallingService';
export { V2NIMUserStatusType } from './V2NIMSubscriptionService';
